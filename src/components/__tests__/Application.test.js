...
describe("Application", () => {
  ...
  //Test whether an appointment can be successfully deleted
  it("loads data, books an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    // 3. Click the "Delete" button on the desired appointment.
  ...
  //Test whether an appointment can be successfully edited
  ...
  it("loads data, books an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    // 6. Check that the element with the text "Deleting" is displayed.
    expect(getByText(appointment, "Deleting")).toBeInTheDocument();
    // 7. Wait until the element with the "Error" button is displayed.
    await waitForElement(() => getByText(appointment, "Error"));
    // 8. Check that the DayListItem with the text "Monday" also has the text "2 spots remaining".
    const day = getAllByTestId(container, "day").find(day =>
      queryByText(day, "Monday")
